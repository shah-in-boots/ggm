...
This outlines how to propose a change to ggm. For a detailed discussion
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("shah-in-boots/ggm", fork = TRUE)`.
...
Please note that the ggm project is released with a [Contributor Code of
Conduct](https://shah-in-boots.github.io/ggm/CODE_OF_CONDUCT.md). By
