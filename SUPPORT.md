...
Thanks for using ggm! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/shah-in-boots/ggm/issues/new).
...
requests](https://github.com/shah-in-boots/ggm/issues) to make sure the
